tutum-docker-mariadb (FORK)
====================

This is the same as https://github.com/tutumcloud/tutum-docker-mariadb/edit/master/README.md
This fork differ only in placement, name and that it uses a different stack of docker layers. Change tutum/mariadb 
for mfrellum/base:mariadb where apropriat.
